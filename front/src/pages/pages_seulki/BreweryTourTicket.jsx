...
export default function BreweryTourTicket() {
  ...
  const handleClick = () => {
    ...
    if (total === 0) {
      ...
      navigate("/brewery/tour/ticketing2", {
        state: {
          pickDate,
          selectedTime,
          total,
            ...
            <div>
              <ul className="brewery-step1-ul">
                ...
                {timeSlots.map((timeSlot, index) => {
                  ...
                  // 선택된 날짜가 오늘이고, 해당 timeSlot이 현재 시간보다 이전이면 출력하지 않음
                  ...
                  return (
                    ...
                    >
                      ...
                      {selectedTime === timeSlot && (
                        <>
                          <ul className="brewery-step1-tour-ul">
                            {list.map((item, index) => (
                              <li
                                key={index}
