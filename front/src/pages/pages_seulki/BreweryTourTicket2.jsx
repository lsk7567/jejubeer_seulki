...
export default function BreweryTourTicket2() {
  ...
  // 총 예약인원
  const title = "양조장투어(Brewery)";
  const payment =
    location.state.total1 * 22000 +
    location.state.total2 * 22000 +
    location.state.total3 * 22000;
            ...
            if (res.data.cnt === 1) {
              ...
              emailjs
                ...
                .then((result) => {
                  ...
                  navigate("/brewery/tour/ticketing3", {
                    state: {
                      formData,
                      title,
                      pickDate,
              ...
              <div className="tour-ticket-step2-list">
                {location.state.total1 > 0 ? (
                  <p className="tour-ticket-step2-list-p">
                    ...
                    <br />
                    (22,000원 × {location.state.total1}명)
                    <p>
                      {(location.state.total1 * 22000).toLocaleString()}&nbsp;원
                    </p>
                  </p>
                ) : null}
                ...
                {location.state.total2 > 0 ? (
                  <p className="tour-ticket-step2-list-p">
                    ...
                    (22,000원 × {location.state.total2}명)
                    <p>
                      {(location.state.total2 * 22000).toLocaleString()}&nbsp;원
                    </p>
                  </p>
                ) : null}
                ...
                {location.state.total3 > 0 ? (
                  <p className="tour-ticket-step2-list-p">
                    ...
                    (22,000원 × {location.state.total3}명)
                    <p>
                      {(location.state.total3 * 22000).toLocaleString()}&nbsp;원
                    </p>
                  </p>
                ) : null}
              </div>
